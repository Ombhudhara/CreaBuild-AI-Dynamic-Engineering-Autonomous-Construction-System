...
import { Loader2, Zap, LayoutGrid, DollarSign, Activity } from 'lucide-react';
...
export default function ConfigPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-950 flex relative items-center justify-center p-6 overflow-hidden">
            ...
            <AnimatePresence>
                ...
                >
                    ...
                    <div className="mb-10 text-center relative">
                        ...
                        <p className="text-indigo-200 mt-3 text-sm font-medium tracking-wide uppercase">Define constraint parameters for the CreaBuild Engine.</p>
                    </div>
